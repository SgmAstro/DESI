...
parser.add_argument('--zmin', type=np.float, help='Minimum redshift limit', default=0.039)
parser.add_argument('--zmax', type=np.float, help='Maximum redshift limit', default=0.263)
